...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ns(e,t,n){let r=new Float32Array(Ho),i=new J(0,1,0);return new _a({name:`SphericalGaussianBlur`,defines:{n:Ho,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:as(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function rs(){return new _a({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:as(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function is(){return new _a({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:as(),fragmentShader:`
	...
	`}var os=class extends Sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var jc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Mc(e,t){let n=jc[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Nc=new J;function Pc(){return X.getLuminanceCoefficients(Nc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Nc.x.toFixed(4)}, ${Nc.y.toFixed(4)}, ${Nc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Cc(i,i.VERTEX_SHADER,y),S=Cc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=kc(i,x,`vertex`),n=kc(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0,blending:2,side:1,depthWrite:!1}))}function ru(e){let t=new wi(new ca(e*1.006,96,64),new _a({uniforms:{lightDirection:{value:new J(-.45,.32,.83).normalize()}},vertexShader:`
      ...
      `,transparent:!0,depthWrite:!1}));return t.renderOrder=2,t}function iu(){let e=document.createElement(`canvas`);e.width=1024,e.height=512;let t=e.getContext(`2d`);if(!t)return new ea(e);t.clearRect(0,0,e.width,e.height);let n=Zl(20260711);for(let r=0;r<7;r+=1){let i=e.height*(.18+r*.11+(n()-.5)*.03),a=18+n()*34;for(let r=0;r<85;r+=1){let r=n()*e.width,o=i+(n()-.5)*a,s=34+n()*110,c=5+n()*18,l=.025+n()*.075,u=t.createRadialGradient(r,o,1,r,o,s*.55);u.addColorStop(0,`rgba(255,255,255,${l})`),u.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=u,t.beginPath(),t.ellipse(r,o,s,c,n()*Math.PI,0,Math.PI*2),t.fill()}}let r=new ea(e);return r.colorSpace=ft,r.wrapS=M,r}function au(){let e=new $n,t=new ya({color:16317439,emissive:2846719,emissiveIntensity:.18,roughness:.34,metalness:.12}),n=new ya({color:12183551,emissive:1728443,emissiveIntensity:.2,roughness:.42,metalness:.08}),r=new ya({color:14283775,emissive:1593247,emissiveIntensity:.18,roughness:.36}),i=new wi(new aa(.026,.032,.32,18),t);i.rotation.x=Math.PI/2,e.add(i);let a=new wi(new oa(.026,.07,18),t);a.rotation.x=-Math.PI/2,a.position.z=-.195,e.add(a);let o=new wi(new ia(.34,.012,.052),n);o.position.z=-.02,e.add(o);let s=new wi(new ia(.17,.01,.036),n);s.position.set(-.08,0,.005),s.rotation.y=-.22,e.add(s);let c=s.clone();c.position.x=.08,c.rotation.y=.22,e.add(c);let l=new wi(new ia(.16,.01,.032),n);l.position.z=.135,e.add(l);let u=new wi(new ia(.018,.075,.04),n);u.position.set(0,.042,.145),u.rotation.x=-.18,e.add(u);for(let t of[-.135,-.068,.068,.135]){let n=new wi(new aa(.014,.014,.034,14),r);n.rotation.x=Math.PI/2,n.position.set(t,-.026,-.035),e.add(n)}let d=new ao(9427199,.65,.55);return d.position.set(0,.04,-.08),e.add(d),e}function ou(e,t,n){let r=T(t,2,7e5);e.position.set(r.x,r.y,r.z);let i=e.position.clone().normalize(),a=new J(1,0,0).applyAxisAngle(i,tn.degToRad(n));e.lookAt(e.position.clone().add(a)),e.up.copy(i)}function su(e){let t=[];for(let n of e){let e=T(n,2,7e5);t.push(e.x,e.y,e.z)}let n=new ti;return n.setAttribute(`position`,new Ur(t,3)),new Wi(n,new Ii({color:16175973,transparent:!0,opacity:.96}))}var cu=class{container;scene=new sr;camera;renderer;cameraController;aircraft=au();clouds;resizeObserver;activePointers=new Map;previousPinchDistance;constructor(e,t){this.container=e,this.camera=new ro(45,1,.1,100),this.camera.position.set(0,2.45,5.2),this.cameraController=new Gl(this.camera),this.renderer=new Wl({antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=ft,this.container.appendChild(this.renderer.domElement),this.bindInteraction(),this.scene.background=new Z(198932),this.scene.add(Xl());let{globe:n,clouds:r}=Jl();this.clouds=r,this.scene.add(n),this.scene.add(su(t.derivedReplayRoute.points)),this.scene.add(this.aircraft);let i=new lo(9353215,1.4),a=new co(16777215,2.8);a.position.set(-4,3,7),this.scene.add(i,a),this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.container),this.resize()}update(e,t,n){ou(this.aircraft,e,t),this.cameraController.setMode(n),this.cameraController.update(e,t)}start(e){this.renderer.setAnimationLoop(t=>{e(t),this.clouds.rotation.y=t*12e-6,this.renderer.render(this.scene,this.camera)})}dispose(){this.renderer.setAnimationLoop(null),this.resizeObserver.disconnect(),this.unbindInteraction(),this.scene.traverse(e=>{(e instanceof wi||e instanceof Wi||e instanceof Zi)&&(e.geometry.dispose(),lu(e.material))}),this.renderer.dispose(),this.renderer.domElement.remove()}resize(){let e=Math.max(1,this.container.clientWidth),t=Math.max(1,this.container.clientHeight);this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1)}bindInteraction(){let e=this.renderer.domElement;e.addEventListener(`pointerdown`,this.handlePointerDown),e.addEventListener(`pointermove`,this.handlePointerMove),e.addEventListener(`pointerup`,this.handlePointerUp),e.addEventListener(`pointercancel`,this.handlePointerUp),e.addEventListener(`wheel`,this.handleWheel,{passive:!1})}unbindInteraction(){let e=this.renderer.domElement;e.removeEventListener(`pointerdown`,this.handlePointerDown),e.removeEventListener(`pointermove`,this.handlePointerMove),e.removeEventListener(`pointerup`,this.handlePointerUp),e.removeEventListener(`pointercancel`,this.handlePointerUp),e.removeEventListener(`wheel`,this.handleWheel),this.activePointers.clear()}handlePointerDown=e=>{this.renderer.domElement.setPointerCapture(e.pointerId),this.activePointers.set(e.pointerId,e),this.previousPinchDistance=this.currentPinchDistance()};handlePointerMove=e=>{let t=this.activePointers.get(e.pointerId);if(t){if(this.activePointers.set(e.pointerId,e),this.activePointers.size>=2){let e=this.currentPinchDistance();if(e&&this.previousPinchDistance){let t=(this.previousPinchDistance-e)/Math.max(160,this.previousPinchDistance);this.cameraController.zoomBy(t)}this.previousPinchDistance=e;return}this.cameraController.rotate(e.clientX-t.clientX,e.clientY-t.clientY)}};handlePointerUp=e=>{this.renderer.domElement.hasPointerCapture(e.pointerId)&&this.renderer.domElement.releasePointerCapture(e.pointerId),this.activePointers.delete(e.pointerId),this.previousPinchDistance=this.currentPinchDistance()};handleWheel=e=>{e.preventDefault(),this.cameraController.zoomBy(e.deltaY*.0012)};currentPinchDistance(){let e=[...this.activePointers.values()];if(e.length<2)return;let[t,n]=e;return Math.hypot(t.clientX-n.clientX,t.clientY-n.clientY)}};function lu(e){if(Array.isArray(e)){for(let t of e)t.dispose();return}e.dispose()}function uu(e){if(!du(e))throw Error(`Journey payload must be an object`);let t=e;if(typeof t.schemaVersion!=`string`||typeof t.id!=`string`)throw Error(`Journey payload is missing schemaVersion or id`);if(!Array.isArray(t.segments)||t.segments.length===0)throw Error(`Journey payload must contain at least one segment`);for(let e of t.segments){if(!du(e))throw Error(`Journey segment must be an object`);let t=e.derivedReplayRoute;if(!du(t)||!Array.isArray(t.points)||t.points.length<2)throw Error(`Journey segment must include a derivedReplayRoute with at least two points`)}}function du(e){return typeof e==`object`&&!!e}async function fu(e){let t=e.name.endsWith(`.travelglobe`)?await h(e):JSON.parse(await e.text());return uu(t),t}function pu(e){let t=gu(e),n=Date.parse(t[0].timestamp),r=Date.parse(t[t.length-1].timestamp);return{startMs:n,endMs:r,durationSeconds:Math.max(1,(r-n)/1e3),totalDistanceMeters:hu(t)}}function mu(e,t){let n=gu(e),r=pu(e),i=r.startMs+Math.min(r.durationSeconds,Math.max(0,t))*1e3,a=0;for(let e=0;e<n.length-1;e+=1){let t=n[e],o=n[e+1],s=Date.parse(t.timestamp),c=Date.parse(o.timestamp),l=S(t,o);if(i<=c){let e=(i-s)/Math.max(1,c-s),n=_u(t,o,e,i),u=l*Math.min(1,Math.max(0,e));return{point:n,bearingDegrees:C(t,o),distanceFlownMeters:a+u,remainingDistanceMeters:Math.max(0,r.totalDistanceMeters-a-u)}}a+=l}let o=n[n.length-1],s=n[n.length-2];return{point:o,bearingDegrees:C(s,o),distanceFlownMeters:r.totalDistanceMeters,remainingDistanceMeters:0}}function hu(e){return e.reduce((t,n,r)=>r===0?t:t+S(e[r-1],n),0)}function gu(e){let t=[...e.derivedReplayRoute.points].sort((e,t)=>Date.parse(e.timestamp)-Date.parse(t.timestamp));if(t.length<2)throw Error(`Segment ${e.id} needs at least two replay points`);return t}function _u(e,t,n,r){let i=w(e,t,n);return{id:`runtime-${e.id}-${t.id}`,journeyId:e.journeyId,segmentId:e.segmentId,timestamp:new Date(r).toISOString(),latitude:i.latitude,longitude:i.longitude,altitudeMeters:i.altitudeMeters,speedMetersPerSecond:vu(e.speedMetersPerSecond??0,t.speedMetersPerSecond??0,n),courseDegrees:C(e,t),source:e.source===`gps`&&t.source===`gps`?`interpolated`:t.source}}function vu(e,t,n){return e+(t-e)*Math.min(1,Math.max(0,n))}function yu(e){let t=e.segments.reduce((e,t)=>e+hu(t.derivedReplayRoute.points),0);return{journeyCount:1,segmentCount:e.segments.length,eventCount:e.events.length,mediaCount:e.media.length,totalDistanceMeters:t,transportModes:[...new Set(e.segments.map(e=>e.type))],countriesVisited:[...new Set(e.segments.flatMap(e=>[e.origin.countryCode??``,e.destination.countryCode??``]).filter(Boolean))]}}function bu(e){let t=e.map(yu);return{journeyCount:e.length,segmentCount:t.reduce((e,t)=>e+t.segmentCount,0),eventCount:t.reduce((e,t)=>e+t.eventCount,0),mediaCount:t.reduce((e,t)=>e+t.mediaCount,0),totalDistanceMeters:t.reduce((e,t)=>e+t.totalDistanceMeters,0),transportModes:[...new Set(t.flatMap(e=>e.transportModes))],countriesVisited:[...new Set(t.flatMap(e=>e.countriesVisited))]}}function xu(e){return[...e.events].sort((e,t)=>Date.parse(e.timestamp)-Date.parse(t.timestamp))}function Su(e){return new Intl.DateTimeFormat(void 0,{hour:`2-digit`,minute:`2-digit`,timeZone:`UTC`,hourCycle:`h23`}).format(new Date(e.timestamp))}function Cu(e){let t=yu(e),n=xu(e),r=n[0],i=n[n.length-1],a=e.segments[0],o=[`# ${e.title}`,``,`Travel Globe replayed this journey from ${a.origin.name} to ${a.destination.name}.`,`Total replay distance was about ${E(t.totalDistanceMeters)} across ${t.segmentCount} segment.`,`The route touched ${t.countriesVisited.join(` and `)} and included ${t.eventCount} timeline events.`,``];r&&i&&o.push(`The journey began with "${r.title}" and ended with "${i.title}".`,``),o.push(`## Timeline`);for(let e of n)o.push(`- ${new Date(e.timestamp).toISOString()}: ${e.title}`);return{title:`${e.title} Journal`,markdown:o.join(`
`)}}function wu(e,t){let n=[];return(e.source===`estimated`||e.source===`interpolated`)&&n.push({id:`gps-estimated`,title:`GPS gap estimated`,body:`Replay is using display-only estimated movement until the next measured fix.`,severity:`warning`}),t<5e8&&n.push({id:`storage-low`,title:`Storage warning`,body:`Available storage is low for long journey recording.`,severity:`warning`}),n}var Tu=[{id:`core-global`,name:`Core Global Labels`,version:`1.0.0`,regionCodes:[`GLOBAL`],sizeBytes:42e6,checksum:`core-global-fixture`},{id:`east-asia-flight`,name:`East Asia Flight Context`,version:`1.0.0`,regionCodes:[`TW`,`JP`],sizeBytes:68e6,checksum:`east-asia-fixture`}];function Eu(e,t,n=new Date().toISOString()){let r={...t,installedAt:n};return{packs:[...e.packs.filter(e=>e.id!==t.id),r]}}function Du(e){return e.packs.reduce((e,t)=>e+t.sizeBytes,0)}function Ou(e){return e<1e3?`${e} B`:e<1e6?`${(e/1e3).toFixed(1)} KB`:e<1e9?`${(e/1e6).toFixed(1)} MB`:`${(e/1e9).toFixed(1)} GB`}var ku={blurEndpointPoints:2,removeTimestamps:!1,removeMedia:!0,removeHomeLocation:!0};function Au(e,t=ku){let n=structuredClone(e);n.title=`${n.title} (share-safe)`,t.removeHomeLocation&&delete n.homeLocation,t.removeMedia&&(n.media=[]);for(let e of n.segments)for(let n of[e.rawRoute,e.processedRoute,e.derivedReplayRoute])n.points=n.points.map((e,n,r)=>ju(e,Mu(n,r.length,t.blurEndpointPoints),t.removeTimestamps));return n.events=n.events.map(e=>({...e,timestamp:t.removeTimestamps?`1970-01-01T00:00:00.000Z`:e.timestamp,mediaIds:[],location:e.location?{...e.location,latitude:Nu(e.location.latitude),longitude:Nu(e.location.longitude)}:void 0})),n.metadata={...n.metadata,privacyRedacted:!0,redactedAt:new Date().toISOString()},n}function ju(e,t,n){return{...e,timestamp:n?`1970-01-01T00:00:00.000Z`:e.timestamp,latitude:t?Nu(e.latitude):e.latitude,longitude:t?Nu(e.longitude):e.longitude,horizontalAccuracyMeters:t?Math.max(e.horizontalAccuracyMeters??0,5e3):e.horizontalAccuracyMeters}}function Mu(e,t,n){return e<n||e>=t-n}function Nu(e){return Math.round(e*20)/20}function Pu(e,t){let n=S(e.home,t.location),r=t.speedMetersPerSecond>2;return e.state===`Idle`&&n>1200&&r?{...e,state:`PossibleJourney`,lastMovedAt:t.timestamp}:e.state===`PossibleJourney`&&n>2500&&r?{...e,state:`JourneyRecording`,lastMovedAt:t.timestamp}:e.state===`JourneyRecording`&&!r?{...e,state:`TemporarilyStationary`}:e.state===`TemporarilyStationary`&&r?{...e,state:`JourneyRecording`,lastMovedAt:t.timestamp}:(e.state===`JourneyRecording`||e.state===`TemporarilyStationary`)&&n<300?{...e,state:`JourneyCompleted`}:e}var Fu=class{durationSeconds;currentSeconds=0;speed=5;isPlaying=!0;constructor(e){this.durationSeconds=Math.max(1,e)}update(e){this.isPlaying&&(this.currentSeconds=Math.min(this.durationSeconds,this.currentSeconds+e*this.speed),this.currentSeconds>=this.durationSeconds&&(this.isPlaying=!1))}seekPercent(e){let t=Math.min(1,Math.max(0,e));this.currentSeconds=this.durationSeconds*t}setSpeed(e){this.speed=Math.max(1,e)}togglePlayback(){this.currentSeconds>=this.durationSeconds&&(this.currentSeconds=0),this.isPlaying=!this.isPlaying}get progressPercent(){return this.currentSeconds/this.durationSeconds}};function Iu(e){let t=bu(e);return{years:[...new Set(e.map(e=>new Date(e.startTime).getUTCFullYear()))].sort(),countries:t.countriesVisited,selectedJourneyIds:e.map(e=>e.id),lifetimeDistanceMeters:t.totalDistanceMeters}}function Lu(e){let t=e.segments[0].origin,n=e.segments[0].destination,r=[{id:t.id,title:t.name,latitude:t.latitude,longitude:t.longitude,priority:`must`,status:`completed`},{id:n.id,title:n.name,latitude:n.latitude,longitude:n.longitude,priority:`must`,status:Ru(e.events)?`completed`:`planned`}];return{title:`${e.title} plan`,plannedPlaces:r,completedCount:r.filter(e=>e.status===`completed`).length}}function Ru(e){return e.some(e=>e.type===`flightLanding`||e.type===`journeyEnded`)}var zu=class{root;adapter;journey;scene;clock;segment;cameraMode=`follow`;lastFrameMs;packState={packs:[]};autoRecordingContext;viewport=document.createElement(`section`);playButton=document.createElement(`button`);speedSelect=document.createElement(`select`);cameraSelect=document.createElement(`select`);scrubber=document.createElement(`input`);hudTitle=document.createElement(`div`);hudRoute=document.createElement(`div`);hudStats=document.createElement(`div`);hudPoint=document.createElement(`div`);belowMe=document.createElement(`div`);capability=document.createElement(`div`);timelineList=document.createElement(`div`);productPanel=document.createElement(`section`);fileInput=document.createElement(`input`);constructor(e,n){this.root=e,this.adapter=new t(n)}async start(){let e=await this.adapter.loadJourney();await this.loadJourney(e)}async loadJourney(e){this.journey=e,this.segment=i(e);let t=pu(this.segment);this.clock=new Fu(t.durationSeconds),this.lastFrameMs=void 0,this.renderShell(e,this.segment),this.scene?.dispose(),this.scene=new cu(this.viewport,this.segment),this.scene.start(e=>this.frame(e)),await this.adapter.saveJourney(e)}renderShell(e,t){this.root.className=`app-shell`,this.viewport.className=`globe-viewport`;let n=document.createElement(`section`);n.className=`overlay`;let r=document.createElement(`section`);r.className=`hud`,this.hudTitle.className=`hud-title`,this.hudRoute.className=`hud-route`,this.hudStats.className=`hud-stats`,this.hudPoint.className=`hud-point`,this.belowMe.className=`below-me`,this.capability.className=`capability`,r.append(this.hudTitle,this.hudRoute,this.hudStats,this.hudPoint,this.belowMe,this.capability);let i=window.matchMedia(`(max-width: 720px)`).matches,a=document.createElement(`section`);a.className=`info-dock`;let o=document.createElement(`details`);o.className=`dock-panel timeline-panel`,o.open=!i;let s=document.createElement(`summary`);s.className=`panel-summary panel-title`,s.textContent=`Timeline`,this.timelineList.className=`timeline-list`,o.append(s,this.timelineList),this.productPanel.className=`product-panel`;let c=document.createElement(`details`);c.className=`dock-panel product-panel-shell`,c.open=!1;let l=document.createElement(`summary`);l.className=`panel-summary panel-title`,l.textContent=`Product Modes`,c.append(l,this.productPanel);let u=document.createElement(`section`);u.className=`controls`,this.playButton.type=`button`,this.playButton.className=`control-button`,this.playButton.addEventListener(`click`,()=>{this.clock?.togglePlayback(),this.syncPlayButton()}),this.speedSelect.className=`control-select`;for(let e of[1,5,20,100]){let t=document.createElement(`option`);t.value=String(e),t.textContent=`${e}x`,this.speedSelect.appendChild(t)}this.speedSelect.value=`5`,this.speedSelect.addEventListener(`change`,()=>{this.clock?.setSpeed(Number(this.speedSelect.value))}),this.cameraSelect.className=`control-select camera-select`;for(let{mode:e,label:t}of[{mode:`follow`,label:`Follow camera`},{mode:`cockpit`,label:`Cockpit view`},{mode:`leftWindow`,label:`Left window`},{mode:`rightWindow`,label:`Right window`},{mode:`tail`,label:`Tail chase`},{mode:`topDown`,label:`Top down`},{mode:`global`,label:`Global orbit`}]){let n=document.createElement(`option`);n.value=e,n.textContent=t,this.cameraSelect.appendChild(n)}this.cameraSelect.value=this.cameraMode,this.cameraSelect.addEventListener(`change`,()=>{this.cameraMode=this.cameraSelect.value}),this.scrubber.className=`timeline-scrubber`,this.scrubber.type=`range`,this.scrubber.min=`0`,this.scrubber.max=`1000`,this.scrubber.value=`0`,this.scrubber.addEventListener(`input`,()=>{this.clock?.seekPercent(Number(this.scrubber.value)/1e3)});let d=document.createElement(`button`);d.type=`button`,d.className=`control-button`,d.textContent=`Import`,d.addEventListener(`click`,()=>this.fileInput.click());let f=document.createElement(`button`);f.type=`button`,f.className=`control-button`,f.textContent=`Export`,f.addEventListener(`click`,()=>this.exportTravelGlobe());let p=document.createElement(`button`);p.type=`button`,p.className=`control-button`,p.textContent=`Share JSON`,p.addEventListener(`click`,()=>this.exportShareSafeJson());let m=document.createElement(`button`);m.type=`button`,m.className=`control-button`,m.textContent=`Journal`,m.addEventListener(`click`,()=>this.exportJournalMarkdown());let h=document.createElement(`button`);h.type=`button`,h.className=`control-button`,h.textContent=`Install Pack`,h.addEventListener(`click`,()=>{this.packState=Eu(this.packState,Tu[1]),this.renderProductPanel()}),this.fileInput.type=`file`,this.fileInput.accept=`.json,.travelglobe,application/json,application/zip`,this.fileInput.hidden=!0,this.fileInput.addEventListener(`change`,()=>{let e=this.fileInput.files?.[0];e&&this.importJourney(e)}),u.append(this.playButton,this.speedSelect,this.cameraSelect,d,f,p,m,h,this.scrubber),a.append(o,c),n.append(r,a,u),this.root.replaceChildren(this.viewport,n,this.fileInput),this.hudTitle.textContent=e.title,this.hudRoute.textContent=`${t.origin.iataCode??t.origin.name} to ${t.destination.iataCode??t.destination.name}`,this.capability.textContent=this.adapter.getLocationCapability().reason??`Standalone browser replay`,this.renderTimeline(e.events),this.renderProductPanel(),this.syncPlayButton()}frame(e){if(!this.clock||!this.scene||!this.segment)return;let t=this.lastFrameMs??e,n=Math.min(.08,(e-t)/1e3);this.lastFrameMs=e,this.clock.update(n);let r=mu(this.segment,this.clock.currentSeconds);this.scene.update(r.point,r.bearingDegrees,this.cameraMode),this.scrubber.value=String(Math.round(this.clock.progressPercent*1e3)),this.syncPlayButton(),this.updateHud(r,this.clock.currentSeconds)}updateHud(e,t){let n=e.point,r=((n.altitudeMeters??0)*3.28084).toFixed(0),i=((n.speedMetersPerSecond??0)*1.94384).toFixed(0),a=Math.floor(t/60),o=Math.floor(t%60).toString().padStart(2,`0`);this.hudStats.textContent=[`ALT ${r} ft`,`GS ${i} kt`,`HDG ${e.bearingDegrees.toFixed(0)}`,`FLOWN ${E(e.distanceFlownMeters)}`,`REM ${E(e.remainingDistanceMeters)}`,`T+${a}:${o}`].join(`  `),this.hudPoint.textContent=`${n.latitude.toFixed(3)}, ${n.longitude.toFixed(3)} | ${n.source}`;let s=te(n,e.bearingDegrees);this.belowMe.textContent=s?`Below me: nearest ${s.feature.name}, ${E(s.distanceMeters)}, ${s.relativeWindow} window`:`Below me: no nearby landmark fixture`,this.journey&&(this.autoRecordingContext=Pu(this.autoRecordingContext??{home:this.journey.segments[0].origin,state:`Idle`},{timestamp:n.timestamp,location:n,speedMetersPerSecond:n.speedMetersPerSecond??0}),this.renderProductPanel(e.point))}syncPlayButton(){this.playButton.textContent=this.clock?.isPlaying?`Pause`:`Play`}renderTimeline(e){let t=xu({events:e}).map(e=>{let t=document.createElement(`button`);return t.type=`button`,t.className=`timeline-item`,t.textContent=`${Su(e)} ${e.title}`,t.addEventListener(`click`,()=>this.seekToEvent(e)),t});this.timelineList.replaceChildren(...t)}seekToEvent(e){if(!this.segment||!this.clock)return;let t=pu(this.segment),n=(Date.parse(e.timestamp)-t.startMs)/1e3;this.clock.seekPercent(n/t.durationSeconds)}async importJourney(e){try{let t=await fu(e);await this.loadJourney(t)}catch(e){this.capability.textContent=e instanceof Error?e.message:`Unable to import journey`}finally{this.fileInput.value=``}}exportTravelGlobe(){this.journey&&_(m(this.journey),`${this.journey.id}.travelglobe`)}exportShareSafeJson(){this.journey&&_(g(Au(this.journey)),`${this.journey.id}.share-safe.json`)}exportJournalMarkdown(){if(!this.journey)return;let e=Cu(this.journey);_(new Blob([e.markdown],{type:`text/markdown`}),`${this.journey.id}.journal.md`)}renderProductPanel(e){if(!this.journey)return;let t=yu(this.journey),n=Lu(this.journey),r=Cu(this.journey),i=Iu([this.journey]),a=e?wu(e,2e9):[],o=[[`Plan`,`${n.completedCount}/${n.plannedPlaces.length} places completed`],[`Journal`,`${r.markdown.split(`
`).length} markdown lines ready`],[`Time Machine`,`${i.years.join(`, `)} | ${E(i.lifetimeDistanceMeters)}`],[`Stats`,`${E(t.totalDistanceMeters)} | ${t.countriesVisited.join(` -> `)}`],[`Offline Packs`,`${this.packState.packs.length} installed | ${Ou(Du(this.packState))}`],[`Auto Recording`,this.autoRecordingContext?.state??`Idle`],[`Notifications`,a.length>0?a.map(e=>e.title).join(`, `):`clear`]],s=document.createElement(`div`);s.className=`product-list`;for(let[e,t]of o){let n=document.createElement(`div`);n.className=`product-row`;let r=document.createElement(`span`);r.textContent=e;let i=document.createElement(`strong`);i.textContent=t,n.append(r,i),s.append(n)}this.productPanel.replaceChildren(s)}},Bu=document.querySelector(`#app`);if(!Bu)throw Error(`Missing #app root element`);new zu(Bu,e).start();