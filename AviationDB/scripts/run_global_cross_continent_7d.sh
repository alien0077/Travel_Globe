...
JOB_DIR="/private/tmp/travel-globe-global-cross-continent-7d"
RAW_ROOT="$ROOT/AviationDB/data/raw/adsblol"
OUTPUT_ROOT="$ROOT/AviationDB/data/releases/private/observed-routes/adsblol/global-cross-continent-7d"
LOG="$JOB_DIR/pipeline.log"
STATUS="$JOB_DIR/status.json"
PID_FILE="$JOB_DIR/pid"
LOCK_DIR="$JOB_DIR/worker.lock"
LABEL="travel-globe-global-cross-continent-7d"
...
/bin/launchctl submit -l "$LABEL" -- /bin/bash "$ROOT/AviationDB/scripts/run_global_cross_continent_7d.sh" __worker
